package com.shulian.safe.drm.module.system.api.logger.dto;
...
public class OperateLogRespDTO implements VO {
    ...
    @Trans(type = TransType.RPC, targetClassName = "com.shulian.safe.drm.module.system.dal.dataobject.user.AdminUserDO",
            fields = "nickname", ref = "userName")
    private Long userId;
    @Schema(description = "用户名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "系统")
    ...
    @Schema(description = "操作内容", requiredMode = Schema.RequiredMode.REQUIRED,
            example = "修改编号为 1 的用户信息，将性别从男改成女，将姓名从系统改成源码")
