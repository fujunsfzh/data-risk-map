package com.shulian.safe.drm.framework.security.core.filter;
...
public class TokenAuthenticationFilter extends OncePerRequestFilter {
    ...
    private LoginUser buildLoginUserByToken(String token, Integer userType) {
        try {
            ...
            String deptId = userInfo.get("deptId");
    ...
    private LoginUser mockLoginUser(HttpServletRequest request, String token, Integer userType) {
        ...
        loginUser.setId(userId)
                ...
                .setUserName(mockSecret)
                .setInfo(Maps.newHashMap())
    ...
    private LoginUser buildLoginUserByHeader(HttpServletRequest request) {
        String loginUserStr = request.getHeader(GlobalConstants.LOGIN_USER_HEADER);
