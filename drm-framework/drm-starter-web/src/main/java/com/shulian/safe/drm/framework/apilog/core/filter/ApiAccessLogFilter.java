package com.shulian.safe.drm.framework.apilog.core.filter;
...
import com.shulian.safe.drm.framework.web.core.filter.ApiRequestFilter;
...
import static com.shulian.safe.drm.framework.apilog.core.interceptor.ApiAccessLogInterceptor.ATTRIBUTE_HANDLER_METHOD;
...
public class ApiAccessLogFilter extends ApiRequestFilter {
    ...
    private boolean buildApiAccessLog(ApiAccessLogCreateReqDTO accessLog, HttpServletRequest request, LocalDateTime beginTime,
        ...
        if (handlerMethod != null) {
            ...
            String operateModule = accessLogAnnotation != null && StringUtils.isNotBlank(accessLogAnnotation.operateModule()) ? accessLogAnnotation.operateModule() :
