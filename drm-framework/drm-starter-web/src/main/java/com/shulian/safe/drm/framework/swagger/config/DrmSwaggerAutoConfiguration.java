package com.shulian.safe.drm.framework.swagger.config;
...
import static com.shulian.safe.drm.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
// 设置为 false 时，禁用
public class DrmSwaggerAutoConfiguration {
