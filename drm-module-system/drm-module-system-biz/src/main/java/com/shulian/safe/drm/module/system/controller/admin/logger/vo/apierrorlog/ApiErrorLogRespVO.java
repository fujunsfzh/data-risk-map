package com.shulian.safe.drm.module.system.controller.admin.logger.vo.apierrorlog;
...
public class ApiErrorLogRespVO {
    ...
    @DictFormat(com.shulian.safe.drm.module.system.enums.DictTypeConstants.USER_TYPE)
