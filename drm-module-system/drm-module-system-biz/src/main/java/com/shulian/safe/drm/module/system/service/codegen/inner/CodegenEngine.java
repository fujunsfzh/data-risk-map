package com.shulian.safe.drm.module.system.service.codegen.inner;
...
import com.shulian.safe.drm.framework.common.exception.util.ServiceExceptionUtil;
...
import com.shulian.safe.drm.framework.common.util.object.ObjectUtils;
import com.shulian.safe.drm.framework.common.util.string.StrUtils;
import com.shulian.safe.drm.framework.excel.core.annotations.DictFormat;
import com.shulian.safe.drm.framework.excel.core.convert.DictConvert;
...
import com.shulian.safe.drm.module.system.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "drm-module-${table.moduleName}/" + // 顶级模块
                "drm-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "drm-module-${table.moduleName}/" + // 顶级模块
                "drm-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "drm-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "drm-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
