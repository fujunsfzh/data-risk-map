package com.shulian.safe.drm.module.system.service.file;
...
import com.shulian.safe.drm.module.system.convert.file.FileConfigConvert;
import com.shulian.safe.drm.module.system.dal.dataobject.file.FileConfigDO;
import com.shulian.safe.drm.module.system.dal.mysql.file.FileConfigMapper;
...
import com.shulian.safe.drm.module.system.framework.file.core.enums.FileStorageEnum;
...
import static com.shulian.safe.drm.framework.common.util.cache.CacheUtils.buildAsyncReloadingCache;
import static com.shulian.safe.drm.module.system.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.shulian.safe.drm.module.system.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImpl implements FileConfigService {
    ...
    public String testFileConfig(Long id) throws Exception {
        ...
        validateFileConfigExists(id);
        // 上传文件
        byte[] content = ResourceUtil.readBytes("file/erweima.png");
        return getFileClient(id).upload(content, IdUtil.fastSimpleUUID() + ".png", "image/png");
    }
