...
import com.shulian.safe.drm.framework.quartz.core.handler.JobHandler;
import com.shulian.safe.drm.framework.quartz.core.scheduler.SchedulerManager;
...
import com.shulian.safe.drm.module.system.controller.admin.job.vo.job.JobSaveReqVO;
import com.shulian.safe.drm.module.system.dal.dataobject.job.JobDO;
import com.shulian.safe.drm.module.system.dal.mysql.job.JobMapper;
import com.shulian.safe.drm.module.system.enums.ErrorCodeConstants;
import com.shulian.safe.drm.module.system.enums.job.JobStatusEnum;
...
import static com.shulian.safe.drm.framework.common.util.collection.CollectionUtils.containsAny;
...
public class JobServiceImpl implements JobService {
    ...
    private void validateJobHandlerExists(String handlerName) {
        ...
        if (handler == null) {
            throw exception(ErrorCodeConstants.JOB_HANDLER_BEAN_NOT_EXISTS);
        }
        if (!(handler instanceof JobHandler)) {
            throw exception(ErrorCodeConstants.JOB_HANDLER_BEAN_TYPE_ERROR);
        }
    }
